    ...
    return (
        <div>
            <Grid container justify="center" >
                <Grid item>
                    <item><Paper style={{ width: 300, height: 430, backgroundColor: 'blanchedalmond', justifyContent: 'center' }}>
                    <h6 key={uuidv4()} >{"Booking Number :  " + data._id}  </h6>
                        ...
                        <h6 key={uuidv4()} >{"Price :  " + data.Price}  </h6>
