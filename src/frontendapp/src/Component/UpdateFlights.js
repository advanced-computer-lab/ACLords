...
export default function UpdateFlights({ row }) {
  ...
  const noOfSeatsAvailable = useRef(row.SeatsAvailableOnFlight);
  ...
  const [noOfAvailableSeatsState, setnoOfAvailableSeatsState] = useState(row.SeatsAvailableOnFlight);
  ...
  return (
    <div className='form-group'>
      ...
      <input type='text' placeholder="Number of Seats Available" ref={noOfSeatsAvailable} value={noOfAvailableSeatsState} onChange={e => setnoOfAvailableSeatsState(e.target.value)} /> <br></br>
